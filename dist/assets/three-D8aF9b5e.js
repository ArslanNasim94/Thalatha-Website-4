...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qa(e,t,n){let r=new Float32Array(Ra),i=new J(0,1,0);return new Si({name:`SphericalGaussianBlur`,defines:{n:Ra,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:to(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function $a(){return new Si({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:to(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function eo(){return new Si({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:to(),fragmentShader:`
